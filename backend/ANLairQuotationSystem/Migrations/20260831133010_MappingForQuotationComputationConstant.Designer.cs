...
namespace ANLairQuotationSystem.Migrations
{
    ...
    [Migration("20260831133010_MappingForQuotationComputationConstant")]
    partial class MappingForQuotationComputationConstant
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ANLairQuotationSystem.Entities.ProjectItem", b =>
                {
                    ...
                    b.HasIndex("UniqueId")
                        .IsUnique()
                        .HasDatabaseName("ix_project_items_unique_id");
